...
# This page creates the Gantt chart(s) for the schedule(s)
...
# A function is created, since it might need to be used twice
# This function creates a gantt chart based on a dataframe, which is the schedule
def create_gantt_chart(dataframe, nummer):
    dataframe_gantt = dataframe.copy(deep=True)
    
    st.write("Below is the Gantt chart of schedule " + str(nummer))
...
# Below the function is executed
